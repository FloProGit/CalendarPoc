    <div class="isolate flex flex-auto flex-col overflow-auto bg-white">
        <div style="width: 165%" class="flex max-w-full flex-none flex-col sm:max-w-none md:max-w-full">
            <div class="sticky top-0 z-30 flex-none bg-white shadow ring-1 ring-black ring-opacity-5 sm:pr-8">
                ...
                @foreach($calendarThisWeek as $dayOfWeek)
                    <div class="flex items-center justify-center py-3 cursor-pointer hover:bg-blue-100">
                        <span>{{$dayOfWeek['day']}} <span class="items-center justify-center font-semibold text-gray-900">{{$dayOfWeek['date']}}</span></span>
                    </div>
                @endforeach
                </div>
...
{{--                        <span>Mon{{$testValue}} <span class="items-center justify-center font-semibold text-gray-900">10</span></span>--}}
{{--                    </div>--}}
{{--                    <div class="flex items-center justify-center py-3">--}}
