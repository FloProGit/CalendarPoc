<div class="shadow ring-1 ring-black ring-opacity-5 lg:flex lg:flex-auto lg:flex-col">
    <div
        ...
        <div class="flex justify-center bg-white py-2">
            <span class="sr-only sm:not-sr-only">Wed</span>
        </div>
        <div class="flex justify-center bg-white py-2">
            <span class="sr-only sm:not-sr-only">Thu</span>
        </div>
        <div class="flex justify-center bg-white py-2">
            <span class="sr-only sm:not-sr-only">Fri</span>
        </div>
        <div class="flex justify-center bg-white py-2">
            <span class="sr-only sm:not-sr-only">Sat</span>
        </div>
        <div class="flex justify-center bg-white py-2">
            <span class="sr-only sm:not-sr-only">Sun</span>
        </div>
    </div>
...
<div class="flex bg-gray-200 text-xs leading-6 text-gray-700 lg:flex-auto ">
    <div class="hidden w-full lg:grid lg:grid-cols-7 lg:grid-rows-6 lg:gap-px">
        @foreach($calendarMonthDays as $CalendarMonthDay)

            @if($CalendarMonthDay['activated'])
            ...
            @else
                <div class="relative bg-gray-50 px-3 py-2 text-gray-500 ">
                    ...
                    -->
                    <time datetime="{{$CalendarMonthDay['date']}}">{{$CalendarMonthDay['currentDay']}}</time>
                </div>
            @endif
